...
fetchDataPlayer('Mikkel_hansen', 'player1', 1, 'country1')
fetchDataPlayer('Simon Pytlick', 'player2', 0, 'country2')
fetchDataClub('FC_Barcelona_Handbol', 'logo1', 0, 'clubName1', 'description1')
fetchDataClub('SC_Magdeburg', 'logo2', 0, 'clubName2', 'description2')