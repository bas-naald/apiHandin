...
fetchDataPlayer('Lionel_messi', 'player1', 0, 'country1')
fetchDataPlayer('cristiano_ronaldo', 'player2', 0, 'country2')
fetchDataClub('barcelona', 'logo1', 0, 'clubName1', 'description1')
fetchDataClub('bayern_munich', 'logo2', 0, 'clubName2', 'description2')